        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Editar Cheque</div>
                    <div class="panel-body">
                        <form class="form-horizontal col-md-10 col-md-offset-1" role="form"
                              action="{{route('cheque.update')}}" method="post">
                            {{ csrf_field() }}

                            <input type="hidden" name="id" id="id" value="{{ $cheque->id }}">
                            <div class="form-group col-md-10{{ $errors->has('nc') ? ' has-error' : '' }}">
                                <label for="nc" class="control-label">N° do Cheque: </label>
                                <input id="nc" type="text" class="form-control" name="nc" value="{{ $cheque->numero }}">
                                @if ($errors->has('nc'))
                            ...
                            <div class="form-group col-md-10{{ $errors->has('des') ? ' has-error' : '' }}">
                                ...
                                <input id="des" type="text" class="form-control" name="des" value="{{ $pagamento->descricao }}"
