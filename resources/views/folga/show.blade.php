                                    ...
                                    @foreach($folgas as $folga)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class='btn btn-info btn-xs' href="../editar/folga/{{$folga->id}}">
                                                    <span class="glyphicon glyphicon-edit"></span> Editar
                                                </a>
                                                <a onclick="return confirm('Deseja excluir esse registro?')" href="../deletar/folga/{{$folga->id}}" class="btn btn-danger btn-xs">
