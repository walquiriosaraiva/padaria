                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal col-md-10 col-md-offset-1" role="form"
                              action="{{route('produto.update')}}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-10 {{ $errors->has('unidade_medida_id') ? ' has-error' : '' }}">
                                ...
                                <select class="form-control" data-live-search="true" id="unidade_medida_id" name="unidade_medida_id">
                                    <option data-tokens="ketchup mustard" value="">Selecione</option>
                                    @foreach($unidade_medida as $key=>$value)
                                        <option data-tokens="ketchup mustard" value="{{ $value->id }}" {{ $value->id == $produto->unidade_medida_id ? 'selected' : '' }}> {{ $value->sigla }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-10{{ $errors->has('qtd_minimo') ? ' has-error' : '' }}">
                                ...
                                <input id="qtd_minimo" type="number" min="1" class="form-control" name="qtd_minimo" value="{{ $produto->qtd_minimo }}">
                            ...
                            <div class="form-group col-md-6{{ $errors->has('val_unitario') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input id="val_unitario" type="text" class="form-control" name="val_unitario" value="{{ $produto->val_unitario }}">
                                </div>
