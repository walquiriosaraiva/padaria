                                    ...
                                    @foreach($boletos as $boleto)
                                        ...
                                        <tr class="{{$classe}}">
                                            ...
                                            <td class="text-center">
                                                <a class='btn btn-info btn-xs' href="../editar/boleto/{{$boleto->id}}">
                                                    <span class="glyphicon glyphicon-edit"></span> Editar
                                                </a>
                                                <a onclick="return confirm('Deseja excluir esse registro?')" href="../deletar/boleto/{{$boleto->id}}" class="btn btn-danger btn-xs">
