        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Editar Boleto</div>
                    <div class="panel-body">
                        <form class="form-horizontal col-md-10 col-md-offset-1" role="form"
                              action="{{route('boleto.update')}}" method="post">
                            {{ csrf_field() }}

                            <input type="hidden" name="id" id="id" value="{{ $boleto->id }}">
                            <div class="form-group col-md-10{{ $errors->has('nf') ? ' has-error' : '' }}">
                                <label for="nf" class="control-label">Nota Fiscal: </label>
                                <input id="nf" type="text" class="form-control" name="nf" value="{{ $boleto->NF }}">
                                @if ($errors->has('nf'))
                            ...
                            <div class="form-group col-md-10{{ $errors->has('des') ? ' has-error' : '' }}">
                                ...
                                <input id="des" type="text" class="form-control" name="des" value="{{ $pagamento->descricao  }}" placeholder="Ex: Compra de farinha ">
                                @if ($errors->has('des'))
                                    <span class="help-block">
                            ...
                            <div class="form-group col-md-10{{ $errors->has('valor') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input id="valor" type="text" class="form-control" name="valor" value="{{ $pagamento->valor }}">
                                </div>
                                @if ($errors->has('valor'))
                                    <span class="help-block">
                            ...
                            <div class="form-group col-md-10{{ $errors->has('data') ? ' has-error' : '' }}">
                                ...
                                <input id="data" type="date" class="form-control" name="data" value="{{ $pagamento->vencimento }}">
                                @if ($errors->has('data'))
                                    <span class="help-block">
